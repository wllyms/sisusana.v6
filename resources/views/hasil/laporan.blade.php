            ...
            <div class="card">
              <div class="card-header">
                <div class="card-title" >Laporan 
                  <a href="/rekapkritik" class="btn btn-primary btn-sm text-white" style="margin-left: 750px"><i class="fas fa-print"></i> Rekap Kritik dan Saran</a>
                  <a href="/rekapsurvey" class="btn btn-primary btn-sm text-white" style="margin-left: 5px"><i class="fas fa-print"></i> Rekap Semua Kuisioner</a>
                </div>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6 col-lg-6">
                    <h6>Tampilkan Berdasarkan Tanggal</h6>
                      ...
                      <form action="{{ route('hasil.tampillaporan') }}" method="GET"> <!-- atau method POST jika diperlukan -->
                          ...
                          <tbody>
                            @foreach ($survey as $no => $data)
                              <tr class="text-center">
                                ...
                                <div>
                                  <td class="d-flex">
                                    <a href="{{ route('survey.detail', $data->id) }}" class="btn btn-sm btn-info">
